class SP_1_Intro extends Phaser.Scene {
  ...
  preload()
  {
    this.load.audio('voice1', ['game/assets/sounds/voices/intro/1.wav']);
    this.load.audio('voice2', ['game/assets/sounds/voices/intro/2.wav']);
    this.load.audio('voice3', ['game/assets/sounds/voices/intro/3.wav']);
    this.load.audio('voice4', ['game/assets/sounds/voices/intro/4.wav']);
    this.load.audio('voice5', ['game/assets/sounds/voices/intro/5.wav']);
    this.load.audio('voice6', ['game/assets/sounds/voices/intro/6.wav']);
    this.load.audio('voice7', ['game/assets/sounds/voices/intro/7.wav']);
    this.load.audio('voice8', ['game/assets/sounds/voices/intro/8.wav']);
    this.load.audio('voice9', ['game/assets/sounds/voices/intro/9.wav']);
    this.load.audio('voice10', ['game/assets/sounds/voices/intro/10.wav']);
    this.load.audio('voice11', ['game/assets/sounds/voices/intro/11.wav']);
    this.load.audio('voice12', ['game/assets/sounds/voices/intro/12.wav']);
    this.load.audio('voice13', ['game/assets/sounds/voices/intro/13.wav']);
    this.load.audio('voice14', ['game/assets/sounds/voices/intro/14.wav']);
    this.load.audio('voice15', ['game/assets/sounds/voices/intro/15.wav']);
    this.load.audio('voice16', ['game/assets/sounds/voices/intro/16.wav']);
