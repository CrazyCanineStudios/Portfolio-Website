class Credits extends Phaser.Scene
{
  ...
  preload()
  {
    this.load.image('credits1',"game/assets/sprites/credits/credits1.png");
    this.load.image('credits2',"game/assets/sprites/credits/credits2.png");
    this.load.image('credits3',"game/assets/sprites/credits/credits3.png");
    this.load.image('credits4',"game/assets/sprites/credits/credits4.png");
    this.load.image('credits5',"game/assets/sprites/credits/credits5.png");
    this.load.image('credits6',"game/assets/sprites/credits/credits6.png");
  }
