...
preload ()
{
    this.load.image('zoey_health', 'game/assets/sprites/user_interface/health/spr_player_zoey_health.png');
    this.load.image('tom_health', 'game/assets/sprites/user_interface/health/spr_player_tom_health.png');
    this.load.image('harry_health', 'game/assets/sprites/user_interface/health/spr_player_harry_health.png');
    this.load.image('health', 'game/assets/sprites/user_interface/health/spr_player_health_bar.png');
    this.load.image('health_mask', 'game/assets/sprites/user_interface/health/spr_health_mask.png');
    this.load.image('pauseScreen', 'game/assets/sprites/user_interface/spr_pause_screen.png');
    this.load.spritesheet('pauseButtons', 'game/assets/sprites/user_interface/spr_pause_buttons.png',{frameWidth: 649, frameHeight: 119});
}
    create ()
    {
        this.doOnce = true;
